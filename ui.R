...
#       style = 'height:900px; overflow-y: scroll',  #adds a scroll bar to sidebar
      tabsetPanel(
        tabPanel(
          "subsystem 1",
          numericInput(
            'Ttime1', 'Input Total time:', 20000, min = 0, step = 1000
          ),
        ...
        tabPanel(
          "subsystem 2",
          numericInput(
            'Ttime2', 'Input Total time:', 20000, min = 0, step = 1000
          ),
          ...
          sliderInput(
            'Reliability_Investment_input2', 'Input Reliability Investment :', min = 0, max = 100000000,value = 60000000, step = 1000000
          ),
